...
<section class="sekciaInfo">
    <div class="pole">
        <p>Každý správny fotograf by mal so sebou mať aj tie správne objektívy a práve pre to tu máme pre teba našu pestrú ponuku, len si vyber!</p>
    </div>
...
<section class="sekciaObsah">
    <div class="pole">
        ...
        <?php
            ...
            $sql = "SELECT nazov, cena, obrazokLINK FROM produkty WHERE kategoria='objektivy'";
