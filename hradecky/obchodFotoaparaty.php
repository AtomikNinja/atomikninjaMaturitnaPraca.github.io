...
<head>
    ...
    <title>Obchod - Fotoaparáty</title>
</head>
<body>
...
<section class="sekciaInfo">
    <div class="pole">
        <p>V našej ponuke fotoaparátov ponúkame fotoaparáty značiek ako Nikon, Canon, Fujifilm, Sony a mnoho ďalších, sme si istý že si dokážeš vybrať.</p>
    </div>
...
<section class="sekciaObsah">
    ...
    <section class="sekciaPolozky">
        ...
        require_once 'includes/dbh.inc.php';
                    ...
                    $sql = "SELECT nazov, cena, obrazokLINK FROM produkty WHERE kategoria='fotoaparaty'";
