...
<section class="sekciaInfo">
    <div class="pole">
        <p>Či už fotíš prírodu, alebo svadbu, tvoje fotky musia byť správne napolohované a nikoho nebaví celý deň držať foťák v ruke. Preto potrebuješ ten správny statív pre správne fungovanie.</p>
    </div>
...
<section class="sekciaObsah">
    <div class="pole">
        ...
        <?php
            ...
            $sql = "SELECT nazov, cena, obrazokLINK FROM produkty WHERE kategoria='stativy'";
